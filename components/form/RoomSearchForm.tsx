...
const formSchema = z
  .object({
    checkIn: z.date(),
    checkOut: z.date(),
    guestNumber: z.number().nonnegative().gte(1),
  })
...
function RoomSearchForm() {
  ...
  return (
    <div className="px-96">
      <div className=" rounded-xl px-8 py-3 mt-12 border border-gray-200 shadow">
        ...
        <Form {...form}>
          ...
          >
            ...
            />
            <Button
              className="py-6 space-y-9 mb-2 text-lg font-medium bg-third text-white"
              type="submit"
            >
              Search
            </Button>
